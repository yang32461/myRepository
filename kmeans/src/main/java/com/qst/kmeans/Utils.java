...
public class Utils {
    ...
    //读取中心文件的数据
	//将所有文件(包括文件夹内部的数据递归读取)，以数组嵌套方式进行	
    public static ArrayList<ArrayList<Double>> getCentersFromHDFS(String centersPath,boolean isDirectory) throws Exception{
    ...
    //删掉文件
    public static void deletePath(String pathStr) throws Exception{
        Configuration conf = new Configuration();
    ...
    public static boolean compareCenters(String centerPath,String newPath) throws Exception{
